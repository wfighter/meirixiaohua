...
// intro / step 1
	...
	<h4>1. 把文件 settings.php.default 改名为 settings.php</h4>
	<h4>2. 把文件 /libs/dbconnect.php.default 改名为 dbconnect.php</h4><br />
	<h4>3. 把以下目录的访问权限设为755(CHMOD 755) , 如果在安装过程中仍然出错则改为 777.</h4>
	<ol>
	<li>/admin/backup/</li>
	...
	<h4>4. 把以下文件访问权限设置为666 (CHMOD 666) </h4>
	<ol>
...
// step 4
	...
	$lang['EnterGod'] = '<p><strong>请输入你的管理员帐号信息:</strong><br />请牢记你的管理员帐号信息,你需要使用它来登入到后台设置你的网站.</p>';
	$lang['GodLogin'] = '管理员用户名';
	$lang['GodPassword'] = '管理员密码';
	$lang['ConfirmPassword'] = '重复输入管理员密码';
	$lang['GodEmail'] = '管理员的E-mail';
...
// Upgrade
	$lang['UpgradeHome'] = '本程序提供 Pligg Beta 9.0.0 或更高版本数据库的升级. 同时也将升级Pligg1.0.0版本的语言文件. 你可能还是需要上传所有的新文件,并且更新你的模板以兼容最新版本.<br /> 我们强烈建议你在升级前在本地备份你的网站和数据库，因为升级将直接影响你当前使用的数据库.';
...
// Errors
	$lang['NotFound'] = '没有找到!';
	$lang['TemplatesCNotFound'] = '没有找到! 请在 /cache 目录下手工创建 /templates_c .';
