<?php require_once('/data/home/hmu129119/htdocs/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-11-20 17:13:36 CST */ ?>
...
" id="thisform2" method="post">
    ...
    <strong><?php echo $this->_confs['PLIGG_Visual_Login_Username']; ?>
:</strong><br />
			<input type="text" name="username_pw" size="25" tabindex="14" value="" />
    <br />
...
<h2><a href="<?php echo $this->_vars['register_url']; ?>
"><?php echo $this->_confs['PLIGG_Visual_Login_NewUsers']; ?>
 </a></h2>
	<p><?php echo $this->_confs['PLIGG_Visual_Login_NewUsersA'];  echo $this->_confs['PLIGG_Visual_Login_NewUsersB'];  echo $this->_confs['PLIGG_Visual_Login_NewUsersC']; ?>
</p>
</div>
