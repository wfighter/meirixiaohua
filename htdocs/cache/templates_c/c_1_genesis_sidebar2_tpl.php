<?php require_once('/data/home/hmu129119/htdocs/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-10-31 17:23:37 CST */ ?>

<?php echo tpl_function_checkActionsTpl(array('location' => "tpl_pligg_sidebar_start"), $this);?>		<?php if ($this->_vars['pagename'] == "groups"): ?>	<!-- START GROUP SORT -->		<div class="headline">			<div class="actiontitle"><?php echo $this->_confs['PLIGG_Visual_Group_Sort']; ?>
...
</a></span>				</div>			</ul>		</div>	<!-- END GROUP SORT -->	<?php endif; ?>		<?php if ($this->_vars['pagename'] == "cloud"): ?>		<div class="headline">			<div class="actiontitle"><?php echo $this->_confs['PLIGG_Visual_Pligg_Queued_Sort']; ?>
...
$this->_vars = $_templatelite_tpl_vars;
unset($_templatelite_tpl_vars);
 ?></div><?php if ($this->_vars['Enable_Tags']): ?>	<?php $this->assign('sidebar_module', "tags"); ?>	<?php $_templatelite_tpl_vars = $this->_vars;
