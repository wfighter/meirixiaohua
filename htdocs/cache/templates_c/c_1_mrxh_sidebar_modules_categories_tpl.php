...
$this->_sections['thecat']['last']	   = ($this->_sections['thecat']['iteration'] == $this->_sections['thecat']['total']);
 if ($this->_vars['lastspacer'] == ""):  $this->assign('lastspacer', $this->_vars['cat_array'][$this->_sections['thecat']['index']]['spacercount']);  endif;  if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['auto_id'] != 0): ?>

<?php if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['spacercount'] < $this->_vars['submit_lastspacer']): ?></ul></li><?php endif;  if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['spacercount'] > $this->_vars['submit_lastspacer']): ?><ul><?php endif; ?>
	...
	<?php if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['principlecat'] == 0): ?></li><?php else:  endif;  $this->assign('submit_lastspacer', $this->_vars['cat_array'][$this->_sections['thecat']['index']]['spacercount']);  endif;  endfor; endif;  echo tpl_function_checkActionsTpl(array('location' => "tpl_widget_categories_end"), $this); if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['spacercount'] < $this->_vars['submit_lastspacer']):  echo $this->_run_modifier($this->_vars['lastspacer'], 'repeat_count', 'plugin', 1, '</ul></li>');  endif; ?>
</ul>
</div>