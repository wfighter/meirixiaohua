<?php require_once('/data/home/hmu129119/htdocs/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-10-25 12:22:31 CST */ ?>
...
"><?php echo $this->_vars['link_category']; ?>
		...
		<?php if ($this->_vars['link_additional_cats']): ?>
			<?php if (count((array)$this->_vars['link_additional_cats'])):  foreach ((array)$this->_vars['link_additional_cats'] as $this->_vars['url'] => $this->_vars['name']): ?>
				| <a href="<?php echo $this->_vars['url']; ?>
