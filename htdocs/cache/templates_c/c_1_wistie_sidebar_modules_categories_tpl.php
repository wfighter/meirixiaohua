...
?>
	...
	<a href="<?php if ($this->_vars['pagename'] == "upcoming" || $this->_vars['groupview'] == "upcoming"):  echo $this->_vars['URL_queuedcategory'].$this->_vars['cat_array'][$this->_sections['thecat']['index']]['safename'];  else:  echo $this->_vars['URL_maincategory'].$this->_vars['cat_array'][$this->_sections['thecat']['index']]['safename'];  endif;  if ($this->_vars['urlmethod'] == 2): ?>/<?php endif; ?>"><?php echo $this->_vars['cat_array'][$this->_sections['thecat']['index']]['name']; ?>
</a>
	...
	<?php $this->assign('submit_lastspacer', $this->_vars['cat_array'][$this->_sections['thecat']['index']]['spacercount']);  endif; ?>

<?php endfor; endif; ?>

<?php echo tpl_function_checkActionsTpl(array('location' => "tpl_widget_categories_end"), $this); if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['spacercount'] < $this->_vars['submit_lastspacer']):  echo $this->_run_modifier($this->_vars['lastspacer'], 'repeat_count', 'plugin', 1, '</ul></li>');  endif; ?>
</ul>
</div>