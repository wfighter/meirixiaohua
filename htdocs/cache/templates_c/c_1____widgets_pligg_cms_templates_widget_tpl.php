...
/templates/admin/images/forum.gif" align="absmiddle"/> <a href="http://forums.pligg.com/" target="_blank">Pligg Forum</a><br/>
							<img src="<?php echo $this->_vars['my_pligg_base']; ?>
/templates/admin/images/bug.gif" align="absmiddle"/> <a href="http://forums.pligg.com/project.php?do=issuelist&projectid=1&issuetypeid=bug" target="_blank">Report a Bug</a><br/>
							<img src="<?php echo $this->_vars['my_pligg_base']; ?>
