<?php require_once('/data/home/hmu129119/htdocs/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-11-08 13:50:20 CST */ ?>
...
>
				<input type="hidden" name="view" value="search">
					...
					<?php endif; ?>
				<input type="search" name="keyword" class="field" value="<?php echo $this->_vars['searchboxtext']; ?>
...
?>				
				<div class="ui-block-a">
					<img src="<?php echo $this->_vars['userlist'][$this->_sections['nr']['index']]['Avatar']; ?>
"> 
				</div>
				<div class="ui-block-b">
					<a href="<?php echo $this->_vars['URL_user'].$this->_vars['userlist'][$this->_sections['nr']['index']]['user_login']; ?>
"><?php echo $this->_vars['userlist'][$this->_sections['nr']['index']]['user_login']; ?>
</a>
					<div><?php echo $this->_confs['PLIGG_Visual_User_Profile_Joined']; ?>
: <?php echo $this->_vars['userlist'][$this->_sections['nr']['index']]['user_date']; ?>
</div>
					<div><?php echo $this->_confs['PLIGG_Visual_User_Profile_Homepage']; ?>
: <?php echo $this->_vars['userlist'][$this->_sections['nr']['index']]['user_url']; ?>
</div>
					<div>Add/Remove:
						<?php if ($this->_vars['userlist'][$this->_sections['nr']['index']]['status'] == 0): ?>	
...
/images/user_delete.gif" align="absmiddle" border="0"/></a>
	...
	<?php else: ?>
		<div class="heading2-inline"><?php echo $this->_confs['PLIGG_Visual_Search_NoResults']; ?>
 '<?php echo $this->_vars['search']; ?>
'</div>
	<?php endif; ?>
		<br/>
...
>
					<input type="hidden" name="view" value="search">
					<input type="search" name="keyword" class="field">
					</form>
				</div>
			<?php endif; ?>
		...
		<div class="user_settings_template">
			...
			<?php if (count((array)$this->_vars['category'])):  $this->_templatelite_vars['foreach'][cate]['iteration'] = 0;  foreach ((array)$this->_vars['category'] as $this->_vars['cat']):  $this->_templatelite_vars['foreach'][cate]['iteration']++; ?>
				...
				<div data-role="fieldcontain">
						<input class="custom" type="checkbox" name="chack[]" id="<?php echo $this->_vars['cat']['category__auto_id']; ?>
" value="<?php echo $this->_vars['cat']['category__auto_id']; ?>
" <?php if (! in_array ( $this->_vars['cat']['category__auto_id'] , $this->_vars['user_category'] )): ?> checked="checked"<?php endif; ?> />
						<label for="<?php echo $this->_vars['cat']['category__auto_id']; ?>
...
>
			...
			<?php endif; ?>
			<?php if ($this->_vars['user_login'] != $this->_vars['user_logged_in']): ?>
			<?php if (check_for_enabled_module ( 'simple_messaging' , 0.6 ) && $this->_vars['is_friend']):  if ($this->_vars['friends']): ?>
				<div class="padding-bottom"><img src="<?php echo $this->_vars['my_pligg_base']; ?>
...
"><?php echo $this->_confs['PLIGG_Visual_User_Profile_View_Friends_2']; ?>
	...
	<div id="wrapper">
		...
		<h3><?php echo $this->_confs['PLIGG_Visual_User_PersonalData']; ?>
</h3>
...
" target="_blank"><?php echo $this->_vars['user_irc']; ?>
				...
				<?php if ($this->_vars['user_login'] == $this->_vars['user_logged_in']): ?>
				<tr>
					<td colspan="2"><input type="button" value="<?php echo $this->_confs['PLIGG_Visual_User_Profile_Modify']; ?>
...
'"></td>
		...
		<div data-role="collapsible">
		<h3><?php echo $this->_confs['PLIGG_Visual_User_Profile_User_Stats']; ?>
</h3>
			<fieldset>
...
:</strong></td>
		...
		<div data-role="collapsible">
		<h3><?php echo $this->_confs['PLIGG_Visual_User_Profile_User_Groups']; ?>
</h3>
			<fieldset>
		...
		<?php if ($this->_vars['Allow_Friends'] != "0"): ?>
		<div data-role="collapsible">
		<h3><?php echo $this->_confs['PLIGG_Visual_User_Profile_Friends']; ?>
</h3>
			<fieldset>
			<?php if ($this->_vars['friends']): ?>			
				<table id="friendlist">
