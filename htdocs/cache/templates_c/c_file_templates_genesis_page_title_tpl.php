<?php require_once('/data/home/hmu129119/htdocs/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-10-28 13:35:40 CST */ ?>
...
<?php if ($this->_vars['pagename'] == "story"): ?><h1><?php echo $this->_vars['posttitle']; ?>
</h1><?php endif; ?>
<!-- END BREADCRUMBS -->
