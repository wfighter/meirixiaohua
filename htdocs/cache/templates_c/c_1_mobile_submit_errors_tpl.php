<?php require_once('/data/home/hmu129119/htdocs/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-11-08 13:49:04 CST */ ?>
...
<?php if ($this->_vars['submit_error'] == 'invalidurl'): ?>
	<div class="error"><?php echo $this->_confs['PLIGG_Visual_Submit2Errors_InvalidURL'];  if ($this->_vars['submit_url'] == "http://"): ?>. <?php echo $this->_confs['PLIGG_Visual_Submit2Errors_InvalidURL_Specify'];  else: ?>: <?php echo $this->_vars['submit_url'];  endif; ?></div>
	<form id="thisform">
