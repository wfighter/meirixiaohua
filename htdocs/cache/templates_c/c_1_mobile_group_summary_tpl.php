<?php require_once('/data/home/hmu129119/htdocs/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-11-08 14:01:21 CST */ ?>
...
<?php if ($this->_vars['is_group_admin'] == '1' && $this->_vars['pagename'] == 'group_story'): ?>
			<div>
...
"/>
							...
							<input type="hidden" name="avatarsource" value="useruploaded"><br/>
