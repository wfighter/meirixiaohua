<?php require_once('/data/home/hmu129119/htdocs/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-12-19 15:06:41 CST */ ?>
...
">
					<?php if ($this->_vars['link_shakebox_currentuser_votes'] == 0 && $this->_vars['link_shakebox_currentuser_reports'] == 0): ?>
						<div><a href="javascript:<?php echo $this->_vars['link_shakebox_javascript_vote']; ?>
"><img src="<?php echo $this->_vars['my_pligg_base']; ?>
/templates/<?php echo $this->_vars['the_template']; ?>
/images/arrow_up.gif" alt="<?php echo $this->_confs['PLIGG_Visual_Vote_For_It']; ?>
" /></a></div>
						
					<?php else: ?>
						<div><img src="<?php echo $this->_vars['my_pligg_base']; ?>
/templates/<?php echo $this->_vars['the_template']; ?>
/images/arrow_up_voted.gif" alt="<?php echo $this->_confs['PLIGG_Visual_Vote_For_It']; ?>
" /></div>
						
					<?php endif; ?>
					
					<div class="votenumber">
						<span class="votenumber"><a id="xvotes-<?php echo $this->_vars['link_shakebox_index']; ?>
"><?php echo $this->_vars['link_shakebox_votes']; ?>
					...
					<?php if ($this->_vars['link_shakebox_currentuser_votes'] == 0 && $this->_vars['link_shakebox_currentuser_reports'] == 0): ?>
						...
						<?php if ($this->_vars['link_shakebox_currentuser_votes'] == 0 && $this->_vars['link_shakebox_currentuser_reports'] == 0): ?>
							<div class="bury"><span id="xreport-<?php echo $this->_vars['link_shakebox_index']; ?>
"><span id="linksummaryBury">
								<a href="javascript:<?php echo $this->_vars['link_shakebox_javascript_report']; ?>
"><img src="<?php echo $this->_vars['my_pligg_base']; ?>
/templates/<?php echo $this->_vars['the_template']; ?>
/images/arrow_down.gif" alt="<?php echo $this->_confs['PLIGG_Visual_Vote_Bury']; ?>
" /></a>
							</span></span></div>
						<?php endif; ?>
					<?php else: ?>
						
						<div class="bury"><img src="<?php echo $this->_vars['my_pligg_base']; ?>
/templates/<?php echo $this->_vars['the_template']; ?>
/images/arrow_down_voted.gif" alt="<?php echo $this->_confs['PLIGG_Visual_Vote_Bury']; ?>
" /></div>
					<?php endif; ?>
				</span>
...
"><?php echo $this->_confs['PLIGG_Visual_AdminPanel_Discard']; ?>
				...
				<?php if ($this->_vars['link_group_id'] != 0): ?>
          		<span id="groupstorystatus">
				    <a href ="<?php echo $this->_vars['my_base_url'];  echo $this->_vars['my_pligg_base']; ?>
/group_story.php?id=<?php echo $this->_vars['link_group_id']; ?>
"><?php echo $this->_vars['link_group_name']; ?>
</a>
		        	<a style='text-decoration:none;padding:2px 0 0 20px;'>群组发布</a>
				</span>
					<?php if ($this->_vars['isadmin'] || $this->_vars['user_logged_in'] == $this->_vars['link_submitter']): ?>	
...
:</b> <?php echo $this->_vars['link_field15'];  endif;  endif; ?> 		  			
			<?php if ($this->_vars['pagename'] != "story" && $this->_vars['pagename'] != "submit"): ?> <?php if ($this->_vars['content_truncate'] == "true"): ?><br /><br /><p><a href="<?php echo $this->_vars['story_url']; ?>
"><u><font >……<?php echo $this->_confs['PLIGG_Visual_Read_More']; ?>
……</font></u></a></p><?php endif;  endif; ?>
      </span>
		</span>
