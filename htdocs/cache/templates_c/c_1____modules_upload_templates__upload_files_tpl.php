<?php /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-10-30 16:56:47 CST */ ?>
...
' value='http://' !onchange='submitUploadForm(this.form)'>
		...
		<br /><br />
    <input type='button' value='确定上传' onclick='submitUploadForm(this.form)'>
