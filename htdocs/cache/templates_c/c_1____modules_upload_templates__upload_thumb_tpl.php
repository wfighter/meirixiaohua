<?php /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-11-23 11:10:49 CST */ ?>
...
<?php if (count((array)$this->_vars['images'])):  foreach ((array)$this->_vars['images'] as $this->_vars['image']): ?>
	...
	<?php 
		...
		echo $format;
	 ?>
    <?php else: ?> <!-- thumb had no format-->
    <?php if ($this->_vars['the_template'] == "mobile"): ?> <!-- for mobile device-->
      <?php if (strpos ( $this->_vars['image']['file_name'] , 'http' ) === 0): ?>
        <a href="<?php echo $this->_vars['image']['file_name']; ?>
" class="miniImg artZoom" target="_blank" title="点我才能看大图哦">
      <?php else: ?>
        <a href="<?php echo $this->_vars['my_pligg_base'];  echo $this->_vars['upload_directory']; ?>
/<?php echo $this->_vars['image']['file_name']; ?>
" class="miniImg artZoom" target="_blank" title="点我才能看大图哦">
    	<?php endif; ?><!--head of A-->
       <img class="small" src='<?php echo $this->_vars['my_pligg_base']; ?>
/modules/upload/templates/images/ClickMe.jpg'/> 
       </a>
    <?php else: ?><!-- for non-mobile device : $the_template-->
    <?php if ($this->_vars['pagename'] == "upcoming"): ?> <!--viewmode is 1 for quick review-->
      <?php if (strpos ( $this->_vars['image']['file_name'] , 'http' ) === 0): ?>
        <a id="imgbox-<?php echo $this->_vars['link_shakebox_index']; ?>
" href="<?php echo $this->_vars['image']['file_name']; ?>
" class="miniImg artZoom" target="_blank" title="点我才能看大图哦">
      <?php else: ?>
        <a href="<?php echo $this->_vars['my_pligg_base'];  echo $this->_vars['upload_directory']; ?>
/<?php echo $this->_vars['image']['file_name']; ?>
" class="miniImg artZoom" target="_blank" title="点我才能看大图哦">
      ...
      <?php if (strpos ( $this->_vars['image']['file_name'] , 'http' ) === 0): ?>
        <img class="small" src='<?php echo $this->_vars['image']['file_name']; ?>
'/> 
      <?php elseif ($this->_vars['image']['file_size'] == 'orig'): ?>
        <img class="small" src='<?php echo $this->_vars['my_pligg_base'];  echo $this->_vars['upload_directory']; ?>
/<?php echo $this->_vars['image']['file_name']; ?>
'/> 
      <?php else: ?>
        <img class="small" src='<?php echo $this->_vars['my_pligg_base'];  echo $this->_vars['upload_thdirectory']; ?>
/<?php echo $this->_vars['image']['file_name']; ?>
'/>
      <?php endif; ?><!--body iamge of A-->
      </a>
    <?php else: ?><!--viewmode is not 1 for normal condition-->
...
" <?php if ($this->_vars['open_in_new_window'] == true): ?> target="_blank"<?php endif; ?> <?php if ($this->_vars['story_status'] != "published"): ?>rel="nofollow"<?php endif; ?>>
				<?php else: ?> 
				  <a href="<?php echo $this->_vars['story_url']; ?>
">
				<?php endif; ?><!--head of A on story-->
			<?php endif; ?>
    <?php endif; ?><!--add link when image had a link-->
	  <?php if (strpos ( $this->_vars['image']['file_name'] , 'http' ) === 0): ?>
...
'/>
  ...
  <?php endif; ?><!--viewmode is 1 or not-->
  <?php endif; ?><!--for mobile or non-mobile device-->
  <?php endif; ?><!-- thumb had format or not-->
<?php endforeach; endif;  echo $this->_vars['upload_thumb_post_format']; ?>
