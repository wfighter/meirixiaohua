...
<!-- END RIGHT COLUMN -->
	...
	<?php if ($this->_vars['pagename'] != "submit" && $this->_vars['pagename'] != "user" && $this->_vars['pagename'] != "profile" && $this->_vars['pagename'] != "login" && $this->_vars['pagename'] != "register" && $this->_vars['pagename'] != "edit"): ?>
<!-- START MIDDLE COLUMN -->
		<div id="midcol">
			<?php $_templatelite_tpl_vars = $this->_vars;
