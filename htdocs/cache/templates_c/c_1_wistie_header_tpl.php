...
</h1><?php endif;  if ($this->_vars['pagename'] == "user"): ?><h1><a href="<?php echo $this->_vars['user_url_personal_data']; ?>
...
<?php if ($this->_vars['pagename'] == "published" || $this->_vars['pagename'] == "index"): ?><h1><?php echo $this->_confs['PLIGG_Visual_Published_News'];  endif;  if ($this->_vars['pagename'] == "upcoming"): ?><h1><?php echo $this->_confs['PLIGG_Visual_Pligg_Queued'];  endif;  if ($this->_vars['pagename'] == "noresults"): ?><h1><?php echo $this->_vars['posttitle']; ?>
...
<?php endif;  if ($this->_vars['posttitle'] != "" && $this->_vars['pagename'] == "page"): ?><h1><?php echo $this->_vars['posttitle']; ?>
</h1><?php endif; ?>
<!-- END BREADCRUMBS -->
