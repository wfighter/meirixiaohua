<?php require_once('/data/home/hmu129119/htdocs/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-11-08 14:00:42 CST */ ?>

<?php echo tpl_function_checkActionsTpl(array('location' => "tpl_pligg_module_simple_messaging_start"), $this); $_templatelite_tpl_vars = $this->_vars;
...
/module.php?module=simple_messaging&view=inbox&action=bulkmod" method="post">
...
?>
						<li data-role="list-divider"><?php if ($this->_vars['msg_array'][$this->_sections['themessage']['index']]['readed'] == 0): ?><strong> <img src="<?php echo $this->_vars['simple_messaging_path']; ?>
images/new.png" align="absmiddle" /> </strong><?php endif; ?>	<?php echo $this->_vars['msg_array'][$this->_sections['themessage']['index']]['date']; ?>
...
">
		...
		<?php else: ?>	
			<div class="heading2-inline margin-top-twentypixel"><?php echo $this->_confs['PLIGG_MESSAGING_No_Messages']; ?>
</div>
		<?php endif; ?>
...
/module.php?module=simple_messaging&view=inbox&action=bulkmod" method="post">
	<table class="listing">
		<tr><th style="width:25%"><?php echo $this->_confs['PLIGG_MESSAGING_From']; ?>
</th><th width="250px"><?php echo $this->_confs['PLIGG_MESSAGING_Subject']; ?>
</th><th style="width:125px"><?php echo $this->_confs['PLIGG_MESSAGING_Sent']; ?>
</th><th style="width:50px"><?php echo $this->_confs['PLIGG_MESSAGING_Delete']; ?>
</th></tr>
...
"><?php echo $this->_vars['msg_array'][$this->_sections['themessage']['index']]['sender_name']; ?>
				...
				<td>
					<?php if ($this->_vars['msg_array'][$this->_sections['themessage']['index']]['readed'] == 0): ?><strong> <img src="<?php echo $this->_vars['simple_messaging_path']; ?>
images/new.png" align="absmiddle" /> </strong><?php endif; ?>
					<a href="<?php echo $this->_vars['URL_simple_messaging_viewmsg'];  echo $this->_vars['msg_array'][$this->_sections['themessage']['index']]['id']; ?>
">
						<?php echo $this->_vars['msg_array'][$this->_sections['themessage']['index']]['title']; ?>
				...
				<td><center><input type="checkbox" name="message[<?php echo $this->_vars['msg_array'][$this->_sections['themessage']['index']]['id']; ?>
]" id="message-<?php echo $this->_vars['msg_array'][$this->_sections['themessage']['index']]['id']; ?>
" value="delete"></center></td>
		...
		<tr><td colspan="3"><div align="center"><br /><?php echo $this->_confs['PLIGG_MESSAGING_No_Messages']; ?>
</div></td></tr>
...
<?php $this->config_load(simple_messaging_pligg_lang_conf, null, null);  echo tpl_function_checkActionsTpl(array('location' => "tpl_pligg_module_simple_messaging_end"), $this);?>