<?php require_once('/data/home/hmu129119/htdocs/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2012-11-01 16:38:12 CST */ ?>
...
<?php if ($this->_vars['pagename'] != "submit"): ?>
	<?php echo tpl_function_checkActionsTpl(array('location' => "tpl_pligg_sidebar2_start"), $this);?>
		<?php if ($this->_vars['pagename'] == "user"): ?>
			<div class="headline">
				<div class="actiontitle"><a href="<?php echo $this->_vars['user_url_personal_data']; ?>
"><?php echo $this->_vars['user_login']; ?>
 的<?php echo $this->_confs['PLIGG_Visual_Profile']; ?>
</a></div>
			</div>
