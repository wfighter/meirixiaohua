...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{$my_pligg_base}/templates/{$the_template}/css/jquery.mobile.css" media="screen" />	
	<link rel="stylesheet" type="text/css" href="{$my_pligg_base}/templates/{$the_template}/css/mpligg.css" media="screen" />	
	...
	<script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/custom-scripting.js"></script>
	<script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/jquery/jquery.mobile.js"></script>
	<script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/mpligg.js"></script>
	...
	{checkForCss}
  <LINK href="{$my_pligg_base}/modules/upload/templates/style/artZoom_mobile.css" type=text/css rel=stylesheet>
	{checkForJs}		
...
<div data-role="page" class="mpage">
