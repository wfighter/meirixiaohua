...
<div class="menuwrapper">
	<ul data-role="listview">
		<li class="tab1" {if $modulepage eq "simple_messaging_inbox" || $modulepage eq "viewmsg"}data-theme="a"{/if}>
			<a href="{$my_pligg_base}/module.php?module=simple_messaging&view=inbox" >
				<img src="{$simple_messaging_img_path}email.png" class="ui-li-icon">
				{#PLIGG_MESSAGING_Inbox#}
			</a>
		</li>

		<li class="tab2" {if $modulepage eq "simple_messaging_sent" ||  $modulepage eq "viewsentmsg"}data-theme="a"{/if}>
			<a href="{$my_pligg_base}/module.php?module=simple_messaging&view=sent">
				<img src="{$simple_messaging_img_path}reply.png" class="ui-li-icon">
		...
		{if $Allow_Friends neq "0"}	 
			<li class="tab3">
				<a href="{$user_url_friends}">
					<img src="{$simple_messaging_img_path}friends.png" class="ui-li-icon">
			...
			<li class="tab4">
				<a href="{$user_url_friends2}">
					<img src="{$simple_messaging_img_path}friends2.png" class="ui-li-icon">
			...
			{if $user_authenticated eq true} 
				<li class="tab5">
					<img src="{$my_pligg_base}/templates/{$the_template}/images/user_search.png" class="ui-li-icon">
