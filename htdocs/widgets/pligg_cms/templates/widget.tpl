							...
							<img src="{$my_pligg_base}/templates/admin/images/bug.gif" align="absmiddle"/> <a href="http://forums.pligg.com/project.php?do=issuelist&projectid=1&issuetypeid=bug" target="_blank">Report a Bug</a><br/>
